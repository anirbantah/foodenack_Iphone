...
@interface FNtagViewController ()<UIScrollViewDelegate,UITableViewDataSource,UITableViewDelegate>{
    UIView *MainView;
...
@implementation FNtagViewController
...
- (void)viewDidLoad {
    ...
    [followerslabel setTitle:@"Popular 20" forState:UIControlStateNormal];
    ...
    [followinglbl setTitle:@"Newest 60" forState:UIControlStateNormal];
