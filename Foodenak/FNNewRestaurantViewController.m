...
@interface FNNewRestaurantViewController ()<UIScrollViewDelegate,UITextFieldDelegate>{
...
- (void)viewDidLoad {
    ...
    [BackButton setFrame:CGRectMake(20,58, backImage.size.width/2, backImage.size.height/2)];
    ...
    UILabel *  KfcBACKLabel = [[UILabel alloc]initWithFrame:CGRectMake(BackButton.frame.origin.x+BackButton.frame.size.width+4,50, 120, backImage.size.height)];
    [KfcBACKLabel setBackgroundColor:[UIColor clearColor]];
    [KfcBACKLabel setText:@"New Restuarant"];
    ...
    if (self.view.frame.size.width == 320) {
        ...
        [DoneButton setFrame:CGRectMake(275, 50, 30, 30)];
    ...
    {
        DoneButton = [UIButton buttonWithType:UIButtonTypeCustom];
        [DoneButton setFrame:CGRectMake(320, 50, 30, 30)];
        [DoneButton setBackgroundImage:[UIImage imageNamed:@"DoneTick"] forState:UIControlStateNormal];
        [DoneButton addTarget:self action:@selector(Donetick:) forControlEvents:UIControlEventTouchUpInside];
        [topview addSubview:DoneButton];
    }
    ...
    MainScroll.contentSize = CGSizeMake(0, 1300);
    
    
    
    
        UIView *MainContainerView=[[UIView alloc]initWithFrame:CGRectMake(30, 20, MainScroll.frame.size.width-60, MainScroll.frame.size.height+728)];
    ...
    if ([[UIScreen mainScreen]bounds].size.width == 320)
    {
        ...
        for (int i=0; i<2; i++) {
            ...
            UILabel *Lbl=[[UILabel alloc]initWithFrame:CGRectMake(12, 10, 100, 20)];
            ...
            UIImageView *ImgView=[[UIImageView alloc]initWithFrame:CGRectMake(Lbl.frame.origin.x+2, Lbl.frame.origin.y+Lbl.frame.size.height+3, 497/2-14, 25)];
            ...
            UITextField *namefield=[[UITextField alloc]initWithFrame:CGRectMake(Lbl.frame.origin.x+2, Lbl.frame.origin.y+Lbl.frame.size.height+3, 497/2-14, 25)];
            [namefield setText:@"abcd"];
            namefield.delegate = self;
            namefield.placeholder = @"Name";
            [namefield setBackgroundColor:[UIColor clearColor]];
            [namefield setTextAlignment:NSTextAlignmentLeft];
            [namefield setTextColor:RGBCOLOR(101, 101, 101, 1)];
            [namefield setFont:HALVELTICA_LIGHT(14)];
        ...
        UIButton *Insiderestrantbutton=[UIButton buttonWithType:UIButtonTypeCustom];
        [Insiderestrantbutton setFrame:CGRectMake(MainContainerView.frame.size.width/2-497/4+5, NAView.frame.size.height+NAView.frame.origin.y+20, 497/2-10, 64/2)];
        [Insiderestrantbutton setBackgroundImage:[UIImage imageNamed:@"InsideBtn"] forState:UIControlStateNormal];
        [Insiderestrantbutton setBackgroundImage:[UIImage imageNamed:@"InsideBtn"] forState:UIControlStateSelected];
        [Insiderestrantbutton setBackgroundImage:[UIImage imageNamed:@"InsideBtn"] forState:UIControlStateHighlighted];
        //[Insiderestrantbutton addTarget:self action:@selector(Insiderestrantbutton:) forControlEvents:UIControlEventTouchUpInside];
        [MainContainerView addSubview:Insiderestrantbutton];
        
        
        UIView *Hs1=[[UIView alloc]initWithFrame:CGRectMake(0, Insiderestrantbutton.frame.origin.y+Insiderestrantbutton.frame.size.height+20, MainContainerView.frame.size.width, 1)];
        [Hs1 setBackgroundColor:RGBCOLOR(230, 230, 230, 1)];
        [MainContainerView addSubview:Hs1];
        
        
        UILabel *LocLbl=[[UILabel alloc]initWithFrame:CGRectMake(12, Hs1.frame.origin.y+12, 100, 20)];
        ...
        for (int i=0; i<3; i++) {
            ...
            UIImageView *ImgView=[[UIImageView alloc]initWithFrame:CGRectMake(LeftPadding-20,10, 497/2-14, 25)];
            [ImgView setImage:[UIImage imageNamed:@"InputCross"]];
            [Subview addSubview:ImgView];
            
            
            UITextField *locationtextfield=[[UITextField alloc]initWithFrame:CGRectMake(LeftPadding+2-20,10, 497/2-70, 25)];
            [locationtextfield setText:@"abcdef"];
            [locationtextfield setTextAlignment:NSTextAlignmentLeft];
            [locationtextfield setPlaceholder:@"Location"];
            [locationtextfield setDelegate:self];
            [locationtextfield setTextColor:RGBCOLOR(101, 101, 101, 1)];
            [locationtextfield setFont:HALVELTICA_LIGHT(14)];
            [Subview addSubview:locationtextfield];
        ...
        UILabel *PhoneLbl=[[UILabel alloc]initWithFrame:CGRectMake(12, Hs2.frame.origin.y+12, 100, 20)];
        ...
        for (int i=0; i<2; i++) {
            ...
            UITextField *phonetextfield=[[UITextField alloc]initWithFrame:CGRectMake(LeftPadding+2-20,10, 497/2-70, 25)];
            [phonetextfield setText:@"abcdef"];
            [phonetextfield setTextAlignment:NSTextAlignmentLeft];
            phonetextfield.placeholder = @"Phone";
            phonetextfield.delegate = self;
            [phonetextfield setTextColor:RGBCOLOR(101, 101, 101, 1)];
            [phonetextfield setFont:HALVELTICA_LIGHT(14)];
        ...
        UILabel *Lbl=[[UILabel alloc]initWithFrame:CGRectMake(12, ShadeImgv.frame.origin.y+ShadeImgv.frame.size.height, 100, 20)];
        [Lbl setText:@"Hours"];
        [Lbl setTextAlignment:NSTextAlignmentLeft];
        [Lbl setTextColor:RGBCOLOR(71, 71, 71, 1)];
        [Lbl setFont:HALVELTICA(16)];
        ...
        for (int i=0; i<8; i++) {
            ...
            UIImageView *ShadeImgv1=[[UIImageView alloc]initWithFrame:CGRectMake(10,10,143/2, 48/2)];
            ...
            UIImageView *ShadeImgv2=[[UIImageView alloc]initWithFrame:CGRectMake(ShadeImgv1.frame.size.width+ShadeImgv1.frame.origin.x+4,10,143/2, 48/2)];
            [ShadeImgv2 setImage:[UIImage imageNamed:@"Hours"]];
            [SubView addSubview:ShadeImgv2];
            
            
            UIButton *wekbutton=[[UIButton alloc]initWithFrame:CGRectMake(0, 2, ShadeImgv1.frame.size.width-4, 20)];
            [wekbutton setTitle:[Arr objectAtIndex:1]forState:UIControlStateNormal];
            wekbutton.titleLabel.textAlignment = NSTextAlignmentCenter;
            [wekbutton setBackgroundColor:[UIColor clearColor]];
            wekbutton.titleLabel.TextColor = [UIColor lightGrayColor];
            wekbutton.titleLabel.Font=HALVELTICA_LIGHT(12);
            // [wekbutton addTarget:self action:@selector(wekbutton:) forControlEvents:UIControlEventTouchUpInside];
            [ShadeImgv2 addSubview:wekbutton];
            
            
            UIImageView *ShadeImgv3=[[UIImageView alloc]initWithFrame:CGRectMake(ShadeImgv2.frame.size.width+ShadeImgv2.frame.origin.x+4,10,143/2, 48/2)];
            [ShadeImgv3 setImage:[UIImage imageNamed:@"Hours"]];
            [SubView addSubview:ShadeImgv3];
            
            
            UIButton *timebutton=[[UIButton alloc]initWithFrame:CGRectMake(0, 2, ShadeImgv1.frame.size.width-4, 20)];
            [timebutton setTitle:[Arr objectAtIndex:2]forState:UIControlStateNormal];
            timebutton.titleLabel.textAlignment = NSTextAlignmentCenter;
            timebutton.titleLabel.TextColor = [UIColor lightGrayColor];
            timebutton.titleLabel.Font=HALVELTICA_LIGHT(12);
            // [timebutton addTarget:self action:@selector(timebutton:) forControlEvents:UIControlEventTouchUpInside];
            [ShadeImgv3 addSubview:timebutton];
            
            
            if (i==0) {
                UIButton *Imgv3=[[UIButton alloc]initWithFrame:CGRectMake(ShadeImgv3.frame.size.width+ShadeImgv3.frame.origin.x+3,10,45/2, 48/2)];
                [Imgv3 setBackgroundImage:[UIImage imageNamed:@"Button-01"] forState:UIControlStateNormal];
                // [Imgv3 addTarget:self action:@selector(crossred:) forControlEvents:UIControlEventTouchUpInside];
            ...
            else
            {
                ...
                UIButton *Imgv3=[[UIButton alloc]initWithFrame:CGRectMake(ShadeImgv3.frame.size.width+ShadeImgv3.frame.origin.x+3,10,45/2, 48/2)];
                [Imgv3 setBackgroundImage:[UIImage imageNamed:@"Button-02"] forState:UIControlStateNormal];
                // [Imgv3 addTarget:self action:@selector(crossred:) forControlEvents:UIControlEventTouchUpInside];
                [SubView addSubview:Imgv3];
            }
        ...
        [Plusbutton setFrame:CGRectMake(MainContainerView.frame.size.width/2-497/4, DayView.frame.size.height+DayView.frame.origin.y+20, 497/2, 64/2)];
        [Plusbutton setBackgroundImage:[UIImage imageNamed:@"Plus-Buton"] forState:UIControlStateNormal];
        [Plusbutton setBackgroundImage:[UIImage imageNamed:@"Plus-Buton"] forState:UIControlStateSelected];
        [Plusbutton setBackgroundImage:[UIImage imageNamed:@"Plus-Buton"] forState:UIControlStateHighlighted];
        //    [Plusbutton addTarget:self action:@selector(Plusbutton:) forControlEvents:UIControlEventTouchUpInside];
        [MainContainerView addSubview:Plusbutton];
        
        
        UIView *Hs44=[[UIView alloc]initWithFrame:CGRectMake(0,Plusbutton.frame.origin.y+Plusbutton.frame.size.height+13, MainContainerView.frame.size.width, 1)];
    ...
    else
    {
        ...
        for (int i=0; i<2; i++) {
            ...
            UIImageView *ImgView=[[UIImageView alloc]initWithFrame:CGRectMake(Lbl.frame.origin.x+2, Lbl.frame.origin.y+Lbl.frame.size.height+3, 497/2, 25)];
            [ImgView setImage:[UIImage imageNamed:@"InputCross"]];
            [Subview addSubview:ImgView];
            ...
            UITextField *namefield=[[UITextField alloc]initWithFrame:CGRectMake(Lbl.frame.origin.x+2, Lbl.frame.origin.y+Lbl.frame.size.height+3, 497/2-70, 25)];
            [namefield setText:@"abcd"];
            namefield.delegate = self;
            namefield.placeholder = @"Name";
            [namefield setBackgroundColor:[UIColor clearColor]];
        ...
        UIButton *Insiderestrantbutton=[UIButton buttonWithType:UIButtonTypeCustom];
        [Insiderestrantbutton setFrame:CGRectMake(MainContainerView.frame.size.width/2-497/4, NAView.frame.size.height+NAView.frame.origin.y+20, 497/2, 64/2)];
        [Insiderestrantbutton setBackgroundImage:[UIImage imageNamed:@"InsideBtn"] forState:UIControlStateNormal];
        [Insiderestrantbutton setBackgroundImage:[UIImage imageNamed:@"InsideBtn"] forState:UIControlStateSelected];
        [Insiderestrantbutton setBackgroundImage:[UIImage imageNamed:@"InsideBtn"] forState:UIControlStateHighlighted];
        //[Insiderestrantbutton addTarget:self action:@selector(Insiderestrantbutton:) forControlEvents:UIControlEventTouchUpInside];
        ...
        for (int i=0; i<3; i++) {
            ...
            UITextField *locationtextfield=[[UITextField alloc]initWithFrame:CGRectMake(LeftPadding+2,10, 497/2-70, 25)];
            [locationtextfield setText:@"abcdef"];
            [locationtextfield setTextAlignment:NSTextAlignmentLeft];
            [locationtextfield setPlaceholder:@"Location"];
            [locationtextfield setDelegate:self];
        ...
        for (int i=0; i<2; i++) {
            ...
            UITextField *phonetextfield=[[UITextField alloc]initWithFrame:CGRectMake(LeftPadding+2,10, 497/2-70, 25)];
            [phonetextfield setText:@"abcdef"];
            [phonetextfield setTextAlignment:NSTextAlignmentLeft];
            phonetextfield.placeholder = @"Phone";
            phonetextfield.delegate = self;
        ...
        for (int i=0; i<8; i++) {
            ...
            if (i==0) {
                UIButton *Imgv3=[[UIButton alloc]initWithFrame:CGRectMake(ShadeImgv3.frame.size.width+ShadeImgv3.frame.origin.x+8,10,45/2, 48/2)];
                [Imgv3 setBackgroundImage:[UIImage imageNamed:@"Button-01"] forState:UIControlStateNormal];
                // [Imgv3 addTarget:self action:@selector(crossred:) forControlEvents:UIControlEventTouchUpInside];
                [SubView addSubview:Imgv3];
            }
